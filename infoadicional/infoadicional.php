...
$obj=new clsConexion;
$result=$obj->consultar("SELECT * from alumno a INNER JOIN matricula m ON m.idalumno = a.idalu");
?>
                ...
                <div class="col-xs-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>INSCRIPCIONES RECIENTES</b></h3>
                            ...
                            <table id="example1" class="table table-striped table-bordered table-hover">
                                ...
                                <?php foreach((array)$result as $row){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "<a href='detalle_inscripcion.php?idalu=".$row['idalu']."' class='btn btn-default btn-sm btn-icon icon-left'>"?><i class="fa fa-pencil-square-o"></i> Detalles</td>
                                    </tr>
                                <?php
                                };
                                ?>
