...
$data=$obj->consultar("SELECT * FROM tipo WHERE idtipo='".$obj->real_escape_string($id)."'");
      foreach($data as $row){
   ...
   <section class="content">
      ...
      <div class="box box-default">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control habilitado requerido" name="descripcion" disabled placeholder="Ejemplo, PROFESOR" maxlength="255" value="<?php echo $descripcion;?>">
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="box-footer">
            <center>
            <button type="submit" class="btn btn-info" id="Modificar" onclick="Actualizar()"><i class="fa fa-pencil"></i><span>Actualizar Cargo</span></button>
