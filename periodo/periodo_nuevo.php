                  ...
                  <div class="col-md-12">
                     ...
                     <div align="center" style="margin-bottom: 20px;">
                        <div class="input-group col-md-3" align="center">
                           ...
                           <input type="number" name="ano" id="ano" class="form-control text-center limpiar" value="<?php echo $ano;?>" placeholder="ingrese el nombre del periodo" maxlength="255">
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              <input type="date" name="pbfi" id="pbfi" class="form-control habilitado limpiar" required value="<?php echo $pbfi;?>" disabled>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              <input type="date" name="pbff" id="pbff" class="form-control habilitado limpiar" required value="<?php echo $pbff;?>" disabled>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              <input type="date" name="sbfi" id="sbfi" class="form-control habilitado limpiar" required value="<?php echo $sbfi;?>" disabled>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              <input type="date" name="sbff" id="sbff" class="form-control habilitado limpiar" required value="<?php echo $sbff;?>" disabled>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              <input type="date" name="tbfi" id="tbfi" class="form-control habilitado limpiar" required value="<?php echo $tbfi;?>" disabled>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              <input type="date" name="tbff" id="tbff" class="form-control habilitado limpiar" required value="<?php echo $tbff;?>" disabled>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              <input type="date" name="cbfi" id="cbfi" class="form-control habilitado limpiar" required value="<?php echo $cbfi;?>" disabled>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              <input type="date" name="cbff" id="cbff" class="form-control habilitado limpiar" required value="<?php echo $cbff;?>" disabled>
                           </div>
                        </div>
                     </div>
                  </div>
...
<script type="text/javascript">
   ...
   function Eliminar(){
      $(".habilitado").prop( "disabled", false );
      $("#Registrar, #Modificar").hide();
      $("#Eliminar span").text("Eliminar Registro");
