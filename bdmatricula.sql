...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-09-2019 a las 13:49:38
...
CREATE TABLE `alumno` (
  ...
  `idapo` int(11) NOT NULL,
  `parentesco` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  ...
  `apepat_alu` varchar(32) NOT NULL,
  `apemat_alu` varchar(34) NOT NULL
...
INSERT INTO `alumno` (`idalu`, `codigo`, `idapo`, `parentesco`, `nombres`, `dni`, `departamento`, `provincia`, `distrito`, `fec_nacimiento`, `genero`, `religion`, `direccion`, `telefono`, `email`, `apepat_alu`, `apemat_alu`) VALUES
(1, 'AL000001', 1, 'PADRE', 'ADRIANO VALENTE', 73260011, 15, 127, 1251, '2015-03-19', 'MASCULINO', 'CATOLICA', 'JR. LALALAL', 956727151, 'adrianovalenteb@gmail.com', 'BRAVO', 'CARBAJAL'),
(2, 'AL000002', 2, 'PADRE', 'ANTONIO', 45781296, 15, 127, 1251, '2012-03-15', 'MASCULINO', 'CATOLICA', 'JR. LALALAL', 956727151, 'hijolalala1123@gmail.com', 'RAMIREZ', 'VARA');
...
CREATE TABLE `apoderado` (
  ...
  `nombre_apo` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `apepat_apo` varchar(50) NOT NULL,
  `apemat_apo` varchar(50) NOT NULL,
  `dni` int(8) NOT NULL,
  `departamento` int(11) NOT NULL,
  `provincia` int(11) NOT NULL,
  `distrito` int(11) NOT NULL,
  ...
  `ocupacion` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `apoderado` (`idapo`, `codigo`, `clave`, `idcargo`, `nombre_apo`, `apepat_apo`, `apemat_apo`, `dni`, `departamento`, `provincia`, `distrito`, `direccion`, `fec_nacimiento`, `genero`, `telefono`, `email`, `ocupacion`, `estado`) VALUES
(1, 'apoderado1', '202cb962ac59075b964b07152d234b70', 4, 'OSCAR', 'BRAVO', 'CARBAJAL', 73260012, 15, 127, 1251, 'JR. LALALAL123123123', '1999-02-25', 'MASCULINO', '956727151', 'oscarmbravoc@gmail.com', 'INGENIERO DE SISTEMAS', 'ACTIVO'),
(2, 'AP000002', 'd9b1d7db4cd6e70935368a1efb10e377', 4, 'JORGE', 'RAMIREZ', 'ULLOA', 45698712, 15, 127, 1251, 'JR. LALALAL', '1985-03-21', 'MASCULINO', '956727151', 'lala123@gmail.com', 'INGENIERO DE SISTEMAS', 'ACTIVO'),
(3, 'AP000003', '202cb962ac59075b964b07152d234b70', 4, 'OSCAR ARTURO', 'BRAVO', 'SERNA', 12345678, 15, 127, 1251, 'JR. PRUEBA NUMERO 1', '2000-02-09', 'MASCULINO', '987456231', 'lala@gmail.com', 'INGENIERO', 'ACTIVO');
...
INSERT INTO `aula` (`idaula`, `idgrado`, `idnivel`, `seccion`, `turno`, `vacantes`) VALUES
(1, 1, 1, 'A', 'MAÑANA', 20),
(2, 2, 1, 'A', 'MAÑANA', 20),
(3, 3, 1, 'A', 'MAÑANA', 19),
(4, 4, 2, 'A', 'MAÑANA', 25),
...
INSERT INTO `calificaciones` (`idcalificacion`, `periodo`, `idcurso`, `pb`, `sb`, `tb`, `cb`, `pf`, `alumno`) VALUES
(1, 2019, 29, 15, 15, 15, 15, 15, 1),
(2, 2019, 25, 15, 15, 15, 15, 15, 1),
(3, 2019, 29, 15, 15, 15, 15, 15, 1);
...
INSERT INTO `conceptopago` (`idconcepto`, `idnivel`, `concepto`, `monto`, `fec_inicio`, `fec_vencimiento`, `mora`, `descuento`) VALUES
(2, 1, 'matricula', '200.00', '2019-09-26', '2019-09-12', '10.00', '0.00');
...
INSERT INTO `configuracion` (`idconfig`, `razon_social`, `ruc`, `departamento`, `provincia`, `distrito`, `direccion`, `telefono`, `moneda`, `imagen_logo`, `imagen_fondo`) VALUES
(1, 'LAS ORQUIDEAS', '10103919512', 15, 127, 1256, 'Asoc. Las Orquídeas Mz. F L. 15 –  Puente Piedra - Lima.', 995444366, 'S/.', 'imagenes/imagen_logo.png', 'imagenes/imagen_fondo.jpg');
...
INSERT INTO `cursos` (`idcurso`, `idnivel`, `idgrado`, `descripcion`) VALUES
(1, 1, 1, 'PSICOMOTRICIDAD'),
(2, 1, 1, 'LOGICO MATEMATICA'),
(3, 1, 1, 'CIENCIA AMBIENTE'),
(4, 1, 1, 'RELIGION'),
(5, 1, 1, 'COMUNICACION'),
(6, 1, 1, 'INGLES'),
(7, 1, 1, 'COMPUTACION'),
...
(9, 1, 2, 'INGLES'),
(10, 1, 2, 'MATEMATICA'),
(11, 1, 2, 'PSICOMOTRICIDAD'),
(12, 1, 2, 'DIBUJO PINTURA'),
(13, 1, 2, 'COMPUTACION'),
(14, 1, 2, 'CIENCIA AMBIENTE'),
(15, 1, 2, 'TEATRO'),
(16, 1, 2, 'PERSONAL SOCIAL'),
(17, 1, 2, 'DANZA'),
(18, 1, 2, 'RELIGION'),
(19, 1, 2, 'PERSONAL SOCIAL'),
(20, 1, 2, 'MUSICA'),
(21, 1, 3, 'COMUNICACION'),
(22, 1, 3, 'INGLES'),
(23, 1, 3, 'MATEMATICA'),
(24, 1, 3, 'PSICOMOTRICIDAD'),
(25, 1, 3, 'DIBUJO PINTURA'),
(26, 1, 3, 'COMPUTACION'),
(27, 1, 3, 'CIENCIA AMBIENTE'),
(28, 1, 3, 'TEATRO'),
(29, 1, 3, 'PERSONAL SOCIAL'),
(30, 1, 3, 'DANZA'),
(31, 1, 3, 'RELIGION'),
(32, 1, 3, 'PERSONAL SOCIAL'),
(33, 1, 3, 'MUSICA'),
(34, 1, 3, 'PREESCRITURA'),
(35, 1, 3, 'PLAN LECTOR'),
(36, 2, 4, 'RAZONAMIENTO MATEMATICO'),
(37, 2, 4, 'LOGICO MATEMATICO'),
(38, 2, 4, 'COMUNICACION INTEGRAL'),
(39, 2, 4, 'RAZONAMIENTO VERBAL'),
(40, 2, 4, 'CIENCIA Y AMBIENTE'),
(41, 2, 4, 'RELIGION'),
(42, 2, 4, 'PERSONAL SOCIAL'),
(43, 2, 4, 'COMPUTACION'),
(44, 2, 4, 'INGLES'),
(45, 2, 4, 'EDUCACION FISICA'),
(46, 2, 4, 'TALLER DE DANZA'),
(47, 2, 4, 'ARTE'),
(48, 2, 5, 'RAZONAMIENTO MATEMATICO'),
(49, 2, 5, 'LOGICO MATEMATICO'),
(50, 2, 5, 'COMUNICACION INTEGRAL'),
(51, 2, 5, 'RAZONAMIENTO VERBAL'),
(52, 2, 5, 'CIENCIA Y AMBIENTE'),
(53, 2, 5, 'EDUCACION FISICA'),
(54, 2, 5, 'TALLER DE DANZA'),
(55, 2, 5, 'INGLES'),
(56, 2, 5, 'ARTE'),
(57, 2, 5, 'RELIGION'),
(58, 2, 5, 'COMPUTACION'),
(59, 2, 5, 'PERSONAL SOCIAL'),
(60, 2, 6, 'LOGICO MATEMATICO'),
(61, 2, 6, 'RAZONAMIENTO MATEMATICO'),
(62, 2, 6, 'CIENCIA Y AMBIENTE'),
(63, 2, 6, 'EDUCACION FISICA'),
(64, 2, 6, 'TALLER DE DANZA'),
(65, 2, 6, 'INGLES'),
(66, 2, 6, 'ARTE'),
(67, 2, 6, 'COMUNICACION INTEGRAL'),
(68, 2, 6, 'RAZONAMIENTO VERBAL'),
(69, 2, 6, 'RELIGION'),
(70, 2, 6, 'PERSONAL SOCIAL'),
(71, 2, 6, 'COMPUTACION'),
(72, 2, 7, 'LOGICO MATEMATICO'),
(73, 2, 7, 'RAZONAMIENTO MATEMATICO'),
(74, 2, 7, 'CIENCIA Y AMBIENTE'),
(75, 2, 7, 'EDUCACION FISICA'),
(76, 2, 7, 'TALLER DE DANZA'),
(77, 2, 7, 'INGLES'),
(78, 2, 7, 'PERSONAL SOCIAL'),
(79, 2, 7, 'RAZONAMIENTO VERBAL'),
(80, 2, 7, 'RELIGION'),
(81, 2, 7, 'ARTE'),
(82, 2, 7, 'COMPUTACION'),
(83, 2, 8, 'LOGICO MATEMATICO'),
(84, 2, 8, 'RAZONAMIENTO MATEMATICO'),
(85, 2, 8, 'CIENCIA Y AMBIENTE'),
(86, 2, 8, 'EDUCACION FISICA'),
(87, 2, 8, 'TALLER DE DANZA'),
(88, 2, 8, 'INGLES'),
(89, 2, 8, 'ALGEBRA'),
(90, 2, 8, 'ARITMETICA'),
(91, 2, 8, 'HISTORIA  DEL PERU'),
(92, 2, 8, 'ARTE'),
(93, 2, 8, 'COMPUTACION'),
(94, 2, 8, 'RELIGION'),
(95, 2, 8, 'COMUNICACION INTEGRAL'),
(96, 2, 8, 'RAZONAMIENTO VERBAL'),
(97, 2, 9, 'LOGICO MATEMATICO'),
(98, 2, 9, 'COMUNICACION INTEGRAL'),
(99, 2, 9, 'RAZONAMIENTO MATEMATICO'),
(100, 2, 9, 'HISTORIA DEL PERU'),
(101, 2, 9, 'EDUCACION FISICA'),
(102, 2, 9, 'TALLER DE DANZA'),
(103, 2, 9, 'INGLES'),
(104, 2, 9, 'RAZONAMIENTO VERBAL'),
(105, 2, 9, 'RELIGION'),
(106, 2, 9, 'TALLER DE MUSICA'),
(107, 2, 9, 'ARTE'),
(108, 2, 9, 'CIENCIA Y AMBIENTE'),
(109, 2, 9, 'COMPUTACION'),
(110, 3, 10, 'QUIMICA'),
(111, 3, 10, 'LENGUAJE'),
(112, 3, 10, 'RAZONAMIENTO MATEMATICO'),
(113, 3, 10, 'TALLER TEATRO'),
(114, 3, 10, 'HISTORIAL PERU'),
(115, 3, 10, 'HISTORIA UNIVERSAL'),
(116, 3, 10, 'COMPRENSION LECTURA'),
(117, 3, 10, 'BIOLOGIA'),
(118, 3, 10, 'EDUCACION FISICA'),
(119, 3, 10, 'DANZA'),
(120, 3, 10, 'INGLES'),
(121, 3, 10, 'ALGEBRA'),
(122, 3, 10, 'ARITMETICA'),
(123, 3, 10, 'GEOMETRIA'),
(124, 3, 10, 'TRIGONOMETRIA'),
(125, 3, 10, 'ORATORIA'),
(126, 3, 10, 'LITERATURA'),
(127, 3, 11, 'QUIMICA'),
(128, 3, 11, 'BOTANICA'),
(129, 3, 11, 'LENGUAJE'),
(130, 3, 11, 'RAZONAMIENTO MATEMATICO'),
(131, 3, 11, 'TALLER TEATRO'),
(132, 3, 11, 'HISTORIAL PERU'),
(133, 3, 11, 'HISTORIA UNIVERSAL'),
(134, 3, 11, 'COMPRENSION LECTURA'),
(135, 3, 11, 'BIOLOGIA'),
(136, 3, 11, 'EDUCACION FISICA'),
(137, 3, 11, 'DANZA'),
(138, 3, 11, 'INGLES'),
(139, 3, 11, 'ALGEBRA'),
(140, 3, 11, 'ARITMETICA'),
(141, 3, 11, 'GEOMETRIA'),
(142, 3, 11, 'TRIGONOMETRIA'),
(143, 3, 11, 'ORATORIA'),
(144, 3, 11, 'LITERATURA'),
(145, 3, 12, 'QUIMICA'),
(146, 3, 12, 'LENGUAJE'),
(147, 3, 12, 'RAZONAMIENTO MATEMATICO'),
(148, 3, 12, 'TALLER TEATRO'),
(149, 3, 12, 'HISTORIAL PERU'),
(150, 3, 12, 'HISTORIA UNIVERSAL'),
(151, 3, 12, 'COMPRENSION LECTURA'),
(152, 3, 12, 'BIOLOGIA'),
(153, 3, 12, 'EDUCACION FISICA'),
(154, 3, 12, 'DANZA'),
(155, 3, 12, 'INGLES'),
(156, 3, 12, 'ALGEBRA'),
(157, 3, 12, 'ARITMETICA'),
(158, 3, 12, 'GEOMETRIA'),
(159, 3, 12, 'TRIGONOMETRIA'),
(160, 3, 12, 'ORATORIA'),
(161, 3, 12, 'LITERATURA'),
(162, 3, 13, 'GEOGRAFIA'),
(163, 3, 13, 'QUIMICA'),
(164, 3, 13, 'LENGUAJE'),
(165, 3, 13, 'RAZONAMIENTO MATEMATICO'),
(166, 3, 13, 'TALLER TEATRO'),
(167, 3, 13, 'HISTORIAL PERU'),
(168, 3, 13, 'HISTORIA UNIVERSAL'),
(169, 3, 13, 'COMPRENSION LECTURA'),
(170, 3, 13, 'BIOLOGIA'),
(171, 3, 13, 'EDUCACION FISICA'),
(172, 3, 13, 'DANZA'),
(173, 3, 13, 'INGLES'),
(174, 3, 13, 'ALGEBRA'),
(175, 3, 13, 'ARITMETICA'),
(176, 3, 13, 'GEOMETRIA'),
(177, 3, 13, 'TRIGONOMETRIA'),
(178, 3, 13, 'ORATORIA'),
(179, 3, 13, 'LITERATURA'),
(180, 3, 14, 'GEOGRAFIA'),
(181, 3, 14, 'QUIMICA'),
(182, 3, 14, 'BOTANICA'),
(183, 3, 14, 'LENGUAJE'),
(184, 3, 14, 'RAZONAMIENTO MATEMATICO'),
(185, 3, 14, 'TALLER TEATRO'),
(186, 3, 14, 'HISTORIAL PERU'),
(187, 3, 14, 'HISTORIA UNIVERSAL'),
(188, 3, 14, 'COMPRENSION LECTURA'),
(189, 3, 14, 'BIOLOGIA'),
(190, 3, 14, 'EDUCACION FISICA'),
(191, 3, 14, 'DANZA'),
(192, 3, 14, 'INGLES'),
(193, 3, 14, 'ALGEBRA'),
(194, 3, 14, 'ARITMETICA'),
(195, 3, 14, 'GEOMETRIA'),
(196, 3, 14, 'TRIGONOMETRIA'),
(197, 3, 14, 'ORATORIA'),
(198, 3, 14, 'LITERATURA');
...
INSERT INTO `cursos_profesor` (`idcurso_prof`, `idaula`, `idcurso`, `idprof`) VALUES
(1, 14, 196, 1),
(2, 9, 97, 8);
...
INSERT INTO `grado` (`idgrado`, `idnivel`, `descripcion`) VALUES
(1, 1, 'Inicial 3 años'),
(2, 1, 'Inicial 4 años'),
(3, 1, 'Inicial 5 años'),
(4, 2, '1° de Primaria'),
...
(8, 2, '5° de Primaria'),
(9, 2, '6° de Primaria'),
(10, 3, '1° de Secundaria'),
(11, 3, '2° de Secundaria'),
(12, 3, '3° de Secundaria'),
(13, 3, '4° de Secundaria'),
(14, 3, '5° de Secundaria');
...
CREATE TABLE `matricula` (
  `idmatri` int(11) NOT NULL,
  `periodo` varchar(255) NOT NULL,
  `num_matricula` varchar(255) NOT NULL,
  `fec_matricula` date NOT NULL,
  `usuario` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `matricula` (`idmatri`, `periodo`, `num_matricula`, `fec_matricula`, `usuario`, `idalumno`, `idgrado`, `idaula`, `observacion`) VALUES
(1, '2019', '0000000001', '2019-09-26', 'JORGE LUIS SERNA BRAVO', 1, 3, 3, 'alumno matriculado de prueba'),
(4, '2019', '0000000002', '2019-09-29', 'JORGE LUIS SERNA BRAVO', 2, 14, 14, 'PRUEBA 3');
...
CREATE TABLE `pago` (
  ...
  `periodo` varchar(255) NOT NULL,
  `numero` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `fecha` date NOT NULL,
  `idmatri` int(11) NOT NULL,
  `idconcepto` int(11) NOT NULL,
  `moraxdias` decimal(18,2) NOT NULL,
  `descuento` decimal(18,2) NOT NULL,
  `subtotal` decimal(18,2) NOT NULL,
  `total` decimal(18,2) NOT NULL,
  `usuario` varchar(255) NOT NULL,
  `pagante` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `pago` (`idpago`, `periodo`, `numero`, `fecha`, `idmatri`, `idconcepto`, `moraxdias`, `descuento`, `subtotal`, `total`, `usuario`, `pagante`) VALUES
(1, '2019', '0000000001', '2019-09-29', 1, 2, '10.00', '0.00', '200.00', '210.00', 'JORGE LUIS SERNA BRAVO', 'OSCAR ARTURO BRAVO HUaMASH'),
(2, '2020', '0000000002', '2019-09-29', 1, 2, '10.00', '0.00', '200.00', '210.00', 'JORGE LUIS SERNA BRAVO', 'OSCAR ARTURO BRAVO HUaMASH');
...
CREATE TABLE `periodo` (
  ...
  `año` int(4) NOT NULL,
  `pri_bim_fec_inicio` date NOT NULL,
  `pri_bim_fec_fin` date NOT NULL,
  `seg_bim_fec_inicio` date NOT NULL,
  `seg_bim_fec_fin` date NOT NULL,
  `ter_bim_fec_inicio` date NOT NULL,
  `ter_bim_fec_fin` date NOT NULL,
  `cua_bim_fec_inicio` date NOT NULL,
  `cua_bim_fec_fin` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `periodo` (`idperiodo`, `año`, `pri_bim_fec_inicio`, `pri_bim_fec_fin`, `seg_bim_fec_inicio`, `seg_bim_fec_fin`, `ter_bim_fec_inicio`, `ter_bim_fec_fin`, `cua_bim_fec_inicio`, `cua_bim_fec_fin`) VALUES
(1, 2017, '2017-03-13', '2017-05-12', '2017-05-15', '2017-07-27', '2017-08-14', '2017-10-13', '2017-10-16', '2017-12-22'),
(2, 2018, '2018-03-13', '2018-05-12', '2018-05-15', '2018-07-27', '2018-08-14', '2018-10-13', '2018-10-16', '2018-12-22'),
(3, 2019, '2019-03-13', '2019-05-12', '2019-05-15', '2019-07-27', '2019-08-14', '2019-10-13', '2019-10-16', '2019-12-22'),
(4, 2020, '2020-03-16', '2020-05-15', '2020-05-18', '2020-07-31', '2020-08-17', '2020-10-12', '2020-10-13', '2020-12-18');
...
INSERT INTO `profesores` (`idprof`, `nombre_prof`) VALUES
(1, 'Oscar Bravo Carbajal'),
(8, 'OSCAR BRAVO CARBAJAL');
...
INSERT INTO `usuario` (`idusu`, `codigo`, `clave`, `idcargo`, `nombres`, `dni`, `fec_nacimiento`, `departamento`, `provincia`, `distrito`, `direccion`, `email`, `telefono`, `fec_ingreso`, `estado`) VALUES
(5, 'ADMIN', '202cb962ac59075b964b07152d234b70', 0, 'JORGE LUIS SERNA BRAVO', 45316858, '1980-04-05', 15, 127, 1260, 'URB. LAS GARAS MZ. F LTE 6', 'ingeniero.jorge.bravo@gmail.com', 977120329, '2017-03-01', 'ACTIVO'),
(6, 'U000001', '202cb962ac59075b964b07152d234b70', 1, 'ROSA GONZALES VEGA', 10236584, '1988-10-12', 15, 127, 1256, 'AV. LOS SAUCES 253', 'direccion@santamariareyna.com.pe', 3625471, '2017-03-01', 'ACTIVO'),
(7, 'U000002', '202cb962ac59075b964b07152d234b70', 2, 'MARCELA GONZALES VEGA', 9245574, '1991-08-07', 15, 127, 1256, 'CALLE LOS CEDROS 526', 'secretaria@santamariareyna.com.pe', 5784471, '2017-03-01', 'ACTIVO'),
(8, 'U000003', '202cb962ac59075b964b07152d234b70', 3, 'OSCAR BRAVO CARBAJAL', 73260012, '1999-02-25', 15, 127, 1262, 'JR. LALAL', 'oscarmbravoc@gmail.com', 956727151, '2019-09-10', 'ACTIVO');
...
CREATE TABLE `voucherpago` (
  ...
  `numero_voucher` int(11) NOT NULL,
  `imagen_voucher` varchar(255) NOT NULL,
  `fecha` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `voucherpago` (`idvoucher`, `idapoderado`, `numero_voucher`, `imagen_voucher`, `fecha`) VALUES
(3, 1, 2147483647, 'voucher/REINICIAR WINDOWS.PNG', '2019-09-29');
...
ALTER TABLE `alumno`
  ...
  ADD KEY `fk_idapo_codigo_2` (`idapo`),
  ADD KEY `fk_iddepar_4` (`departamento`),
  ADD KEY `fk_idprov_4` (`provincia`),
  ADD KEY `fk_iddistri_4` (`distrito`);

--
-- Indices de la tabla `apoderado`
--
ALTER TABLE `apoderado`
  ADD PRIMARY KEY (`idapo`),
  ADD KEY `fk_iddep_2` (`departamento`),
  ADD KEY `fk_idprov_2` (`provincia`),
  ADD KEY `fk_iddist_2` (`distrito`),
...
ALTER TABLE `aula`
  ...
  ADD KEY `fk_idgrad_2` (`idgrado`),
  ADD KEY `fk_idniv_1` (`idnivel`);
...
ALTER TABLE `calificaciones`
  ...
  ADD KEY `fk_idcurs_4` (`idcurso`),
  ADD KEY `fk_idaul_4` (`alumno`),
  ADD KEY `fk_idperio_2` (`periodo`);
...
ALTER TABLE `configuracion`
  ...
  ADD KEY `fk_iddep_3` (`departamento`),
  ADD KEY `fk_idprov_3` (`provincia`),
  ADD KEY `fk_iddist_3` (`distrito`);
...
ALTER TABLE `cursos`
  ...
  ADD KEY `fk_idniv_2` (`idnivel`),
  ADD KEY `fk_idgrad_3` (`idgrado`);

--
-- Indices de la tabla `cursos_profesor`
--
ALTER TABLE `cursos_profesor`
  ADD PRIMARY KEY (`idcurso_prof`),
  ADD KEY `fk_idalu_2` (`idaula`),
  ADD KEY `fk_idcurs_2` (`idcurso`),
  ADD KEY `fk_idprof_1` (`idprof`);
...
ALTER TABLE `matricula`
  ADD PRIMARY KEY (`idmatri`),
  ADD KEY `fk_idalu_1` (`idalumno`),
  ADD KEY `fk_idgrad_1` (`idgrado`),
  ADD KEY `fk_idaul_1` (`idaula`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fk_idcargo_1` (`idcargo`),
  ADD KEY `fk_iddepar_1` (`departamento`),
  ADD KEY `fk_idprov_1` (`provincia`),
  ADD KEY `fk_iddistri_1` (`distrito`);
...
--
ALTER TABLE `apoderado`
  MODIFY `idapo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `cursos_profesor`
  MODIFY `idcurso_prof` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `matricula`
  MODIFY `idmatri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT de la tabla `voucherpago`
--
ALTER TABLE `voucherpago`
...
--
ALTER TABLE `alumno`
  ADD CONSTRAINT `fk_idapo_codigo_2` FOREIGN KEY (`idapo`) REFERENCES `apoderado` (`idapo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_iddepar_4` FOREIGN KEY (`departamento`) REFERENCES `ubdepartamento` (`idDepa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_iddistri_4` FOREIGN KEY (`distrito`) REFERENCES `ubdistrito` (`idDist`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idprov_4` FOREIGN KEY (`provincia`) REFERENCES `ubprovincia` (`idProv`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `apoderado`
--
ALTER TABLE `apoderado`
  ADD CONSTRAINT `fk_idcargo_3` FOREIGN KEY (`idcargo`) REFERENCES `tipo` (`idTipo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_iddep_2` FOREIGN KEY (`departamento`) REFERENCES `ubdepartamento` (`idDepa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_iddist_2` FOREIGN KEY (`distrito`) REFERENCES `ubdistrito` (`idDist`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idprov_2` FOREIGN KEY (`provincia`) REFERENCES `ubprovincia` (`idProv`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `aula`
--
ALTER TABLE `aula`
  ADD CONSTRAINT `fk_idgrad_2` FOREIGN KEY (`idgrado`) REFERENCES `grado` (`idgrado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idniv_1` FOREIGN KEY (`idnivel`) REFERENCES `nivel` (`idnivel`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `calificaciones`
--
ALTER TABLE `calificaciones`
  ADD CONSTRAINT `fk_idaul_4` FOREIGN KEY (`alumno`) REFERENCES `alumno` (`idalu`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idcurs_4` FOREIGN KEY (`idcurso`) REFERENCES `cursos` (`idcurso`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idperio_2` FOREIGN KEY (`periodo`) REFERENCES `periodo` (`año`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `conceptopago`
--
ALTER TABLE `conceptopago`
  ADD CONSTRAINT `fk_idniv_5` FOREIGN KEY (`idnivel`) REFERENCES `nivel` (`idnivel`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `configuracion`
--
ALTER TABLE `configuracion`
  ADD CONSTRAINT `fk_iddep_3` FOREIGN KEY (`departamento`) REFERENCES `ubdepartamento` (`idDepa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_iddist_3` FOREIGN KEY (`distrito`) REFERENCES `ubdistrito` (`idDist`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idprov_3` FOREIGN KEY (`provincia`) REFERENCES `ubprovincia` (`idProv`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `cursos`
--
ALTER TABLE `cursos`
  ADD CONSTRAINT `fk_idgrad_3` FOREIGN KEY (`idgrado`) REFERENCES `grado` (`idgrado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idniv_2` FOREIGN KEY (`idnivel`) REFERENCES `nivel` (`idnivel`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `cursos_profesor`
--
ALTER TABLE `cursos_profesor`
  ADD CONSTRAINT `fk_idalu_2` FOREIGN KEY (`idaula`) REFERENCES `aula` (`idaula`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idcurs_2` FOREIGN KEY (`idcurso`) REFERENCES `cursos` (`idcurso`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idprof_1` FOREIGN KEY (`idprof`) REFERENCES `profesores` (`idprof`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `matricula`
--
ALTER TABLE `matricula`
  ADD CONSTRAINT `fk_idalu_1` FOREIGN KEY (`idalumno`) REFERENCES `alumno` (`idalu`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idaul_1` FOREIGN KEY (`idaula`) REFERENCES `aula` (`idaula`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idgrad_1` FOREIGN KEY (`idgrado`) REFERENCES `grado` (`idgrado`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pago`
--
ALTER TABLE `pago`
  ADD CONSTRAINT `fk_idconcepto_2` FOREIGN KEY (`idconcepto`) REFERENCES `conceptopago` (`idconcepto`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idmatri_2` FOREIGN KEY (`idmatri`) REFERENCES `matricula` (`idmatri`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_idcargo_1` FOREIGN KEY (`idcargo`) REFERENCES `tipo` (`idTipo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_iddepar_1` FOREIGN KEY (`departamento`) REFERENCES `ubdepartamento` (`idDepa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_iddistri_1` FOREIGN KEY (`distrito`) REFERENCES `ubdistrito` (`idDist`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_idprov_1` FOREIGN KEY (`provincia`) REFERENCES `ubprovincia` (`idProv`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `voucherpago`
--
ALTER TABLE `voucherpago`
  ADD CONSTRAINT `fk_idapo_2` FOREIGN KEY (`idapoderado`) REFERENCES `apoderado` (`idapo`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
