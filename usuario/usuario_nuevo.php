...
$result=$obj->consultar('select count(codigo) as cuenta ,Max(codigo) as maximo from usuario');
foreach((array)$result as $row){
   ...
   if($count==0){
      ...
      $codigo='U'.substr((substr($max,1)+1000001),1);
   }
}
?>
<head>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control requerido" name="codigo" readonly="true" value="<?php echo $codigo;?>">
                        </div>
                     </div>
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control requerido" name="nombres" placeholder="Por ejemplo, Jorge Serna Bravo" value="">
                        </div>
                     </div>                     
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control requerido" name="direccion" autocomplete="off" placeholder="ingrese la direccion"  value="">
                        </div>
                     </div>
                     <div class="form-group">
                        <label>Genero:</label>
                  ...
                  <div class="col-md-6">                     
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control select2 requerido" style="width: 100%;" name="cargo">
                           <?php
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control numero" name="tel" placeholder="Numero de telefono o celular" value="">
                        </div>
                     </div>                     
