...
$result=$objcliente->consultar("SELECT * FROM nivel");
?>
<head>
   ...
   <section class="content">
      <div class="box box-info">
         ...
         <div class="box-header">
            <a href="nivel_nuevo.php" class="btn btn-primary btn-flat"><i class="fa fa-level-up"></i> Registrar Nuevo Nivel </a>
         </div>
         <div class="box-body">
            <table id="example1" class="table table-striped table-bordered table-hover">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><?php echo "<a href='nivel_acciones.php?idnivel=".$row['idnivel']."' class='btn btn-default btn-sm btn-icon icon-left'>"?><i class="fa fa-pencil-square-o"></i> Editar</td>
                     <td><?php echo "<a href='procesar.php?idnivel=".$row['idnivel']."&Eliminar=Eliminar' class='btn btn-danger btn-sm btn-icon icon-left'>"?><i class="fa fa-trash-o"></i> Eliminar</td>
                  </tr>
                  <?php
                  };
                  ?>
