   ...
   <section class="content">
      ...
      <div class="box box-default">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control requerido" name="apepat" placeholder="Por ejemplo, Bravo">
                        </div>
                     </div>
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control requerido" name="apemat" placeholder="Por ejemplo, Serna">
                        </div>
                     </div>
                     <div class="form-group">
                        <label>Nombres:</label>
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control requerido" placeholder="Nombre y número de calle" name="direccion">
                        </div>
                     </div>
                     <div class="form-group">
         ...
         <div class="box-footer">
            <center>
               <button type="submit" class="btn btn-info" onclick="Registrar()"><i class="fa fa-pencil"></i><span>Registrar Nuevo Estudiante</span></button>
